...
const slides: Slide[] = [
  ...
  { kicker: "Selected Installations", title: "From Qatar to International Poultry Operations", type: "markets", image: "/images/world-map.png" },
...
function Scene({ slide, index }: { slide: Slide; index: number }) {
  ...
  if (slide.type === "markets") return frame(<div><h2 className="scene-title reveal">{slide.title}</h2><div className="markets-layout"><div className="market-list reveal"><span>EXAMPLES IN THE SUPPLIED PRESENTATION</span><b>Serbia — slaughterhouse</b><b>Iran — two installations</b><b>France — large hen farm</b><b>Qatar — two poultry farms</b></div><div className="map reveal"><img src={slide.image} alt="World map" /><i className="pin france">France</i><i className="pin serbia">Serbia</i><i className="pin iran">Iran</i><i className="pin qatar">Qatar</i></div></div></div>);
